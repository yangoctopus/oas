...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${ctx}/style/images/title_arrow.gif"/> 岗位设置
        </div>
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td>
                        	...
                        	<s:textfield name="pname" cssClass="InputStyle"></s:textfield>
                         *</td>
                    </tr>
                    <tr>
                        <td>岗位说明</td>
                        ...
                        <s:textarea name="pdesc" cssClass="TextareaStyle"></s:textarea>
                        </td>
                    </tr>
                </table>
            </div>
...
<script>
    function save(){
        $.ajax({
            url:'postAction_updatePost.action',
